...
import { FetchRpcEndpointType, FetchRpcProps, FetchRpcReturn, GeneralObject, Optional, fetchRpc } from "..";
...
export type FetchBullEndpointType<ParamsType extends FetchBullParamsType = any, ResultType extends FetchBullResultType = any> =
  // alias
...
export type ConvertBullToRpcParamsType<ParamsType extends FetchBullParamsType = any> = ParamsType;

// Alias (no conversion needed)
//    Rpc result do not need to be updated to be used as Bull result
export type ConvertRpcToBullResultType<ResultType extends FetchBullResultType = any> = ResultType;
...
export type ConvertBullToRpcEndpointType<BullEndpointType extends FetchBullEndpointType = FetchBullEndpointType> =
  FetchRpcEndpointType<
    ConvertBullToRpcParamsType<BullEndpointType['ParamsType']>,  // => RPC.ParamsType
    ConvertRpcToBullResultType<BullEndpointType['ResultType']>   // => RPC.ResultType
  >
